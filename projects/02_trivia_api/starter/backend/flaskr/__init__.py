...
def create_app(test_config=None):
    ...
    '''
    # since catecories needed in more than one page in this project so
    # i see making seperate function to generate them is better
    ...
    def search_Question():
        ...
        try:
            if searchTerm == ',':
                ...
                search_results = Question.query.order_by(Question.category)\
    ...
    def Questions_by_category(Category_id):
        ...
        Questions_by_category = Question.query.order_by(Question.id)\
    ...
    def Play_Question():
        ...
        try:
            ...
            # Using the python built in function random()
            # to get a random Question from the Quiz_Questions list
